# Crayon Notes · Crayon Photo Illustration

[← Albert’s Imagebook](../../README.md) · [简体中文](README.zh-CN.md) · [Full prompt](prompt.md)

**Wax grain · wonky lines · a few warm colors**

A small, imperfect crayon recollection of a walk, a trip, or an ordinary day.

![Crayon Notes: Wax grain · wonky lines · a few warm colors](assets/beach-centered-artwork.webp)

## The signature

Broken wax marks and uneven fills make the memory feel personal and handmade.

**Best for:** Travel, streets, family moments.
...
```text
Use $albert-imagebook. Turn this photo into Crayon Notes, no text.
```

The default is a 1080×1440 portrait artwork. To reproduce this page's comparison layout, ask:

```text
Use Crayon Notes, top-bottom, original above artwork, 50:50, 1080×1440, no text.
```
...
| --- | --- |
| [![Crayon Notes: café photo transformed into crayon photo illustration](assets/coffee-terrace-65-artwork.webp)](assets/coffee-terrace-65-comparison.webp) | [![Crayon Notes: tree-lined street in crayon photo illustration](assets/tree-street-65-artwork.webp)](assets/tree-street-65-comparison.webp) |
...
Use the English name **Crayon Notes**, Chinese name **蜡笔小记**, or stable ID `crayon-memory-postcard`.
