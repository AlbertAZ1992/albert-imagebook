...
![蜡笔小记：蜡粒纸感 · 歪拙线条 · 少量暖色](assets/beach-centered-artwork.webp)

## 这一页的特色

蜡笔的断续颗粒和不整齐的填色，带一点笨拙的亲切感。
...
```text
用 $albert-imagebook，把这张照片做成「蜡笔小记」，不加字。
```

默认生成 1080×1440 的竖版纯作品。要复现本页的上下对照排版，可以说：

```text
用「蜡笔小记」，原图在上、作品在下，各占一半，成品 1080×1440，不加字。
```
...
| 咖啡露台 | 树下街巷 |
| --- | --- |
| [![蜡笔小记：咖啡露台照片转蜡笔画](assets/coffee-terrace-65-artwork.webp)](assets/coffee-terrace-65-comparison.webp) | [![蜡笔小记：林荫街道照片转蜡笔画](assets/tree-street-65-artwork.webp)](assets/tree-street-65-comparison.webp) |
...
可以直接用中文名「蜡笔小记」、英文名「Crayon Notes」或风格 ID `crayon-memory-postcard` 调用。
