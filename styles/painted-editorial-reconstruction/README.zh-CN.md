...
![笔触叙事：宽笔触 · 大色面 · 动作与气氛](assets/beach-centered-artwork.webp)

## 这一页的特色

用较宽的笔触和色面组织叙事；比轻线丙烯更有绘画动作和空间层次。
...
```text
用 $albert-imagebook，把这张照片做成「笔触叙事」，不加字。
```

默认生成 1080×1440 的竖版纯作品。要复现本页的上下对照排版，可以说：

```text
用「笔触叙事」，原图在上、作品在下，各占一半，成品 1080×1440，不加字。
```

## 原图与作品

![海边日落：原图在上、作品在下](assets/beach-centered-comparison.webp)
...
| 咖啡露台 | 树下街巷 |
| --- | --- |
| [![笔触叙事：咖啡露台照片转笔触插画](assets/coffee-terrace-65-artwork.webp)](assets/coffee-terrace-65-comparison.webp) | [![笔触叙事：林荫街道照片转笔触插画](assets/tree-street-65-artwork.webp)](assets/tree-street-65-comparison.webp) |
...
可以直接用中文名「笔触叙事」、英文名「Painterly Stories」或风格 ID `painted-editorial-reconstruction` 调用。
