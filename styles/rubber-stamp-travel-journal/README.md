# Travel Stamps · Photo to Rubber Stamp Art

[← Albert’s Imagebook](../../README.md) · [简体中文](README.zh-CN.md) · [Full prompt](prompt.md)

**Carved contours · imperfect registration · warm paper**

Distill a roofline, street, or shoreline into a small layered ink impression worth keeping.

![Travel Stamps: Carved contours · imperfect registration · warm paper](assets/beach-artwork.webp)

## The signature

Dry ink gaps, carved marks, and misregistered colors preserve a place through its contours.

**Best for:** Cities, streets, architecture, travel landscapes.
...
```text
Use $albert-imagebook. Turn this photo into Travel Stamps, no text.
```

The default is a 1080×1440 portrait artwork. To reproduce this page's comparison layout, ask:

```text
Use Travel Stamps, top-bottom, original above artwork, 50:50, 1080×1440, no text.
```

## Original → artwork

![Beach sunset: original above artwork](assets/beach-comparison.webp)
...
| --- | --- |
| [![Travel Stamps: café photo transformed into photo to rubber stamp art](assets/coffee-terrace-65-artwork.webp)](assets/coffee-terrace-65-comparison.webp) | [![Travel Stamps: tree-lined street in photo to rubber stamp art](assets/tree-street-65-artwork.webp)](assets/tree-street-65-comparison.webp) |
...
Use the English name **Travel Stamps**, Chinese name **旅途印记**, or stable ID `rubber-stamp-travel-journal`.
