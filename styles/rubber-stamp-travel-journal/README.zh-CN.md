...
![旅途印记：手刻轮廓 · 错位套印 · 温暖旧纸](assets/beach-artwork.webp)

## 这一页的特色

油墨断裂、刻痕和套印偏移，保留地点轮廓，减少照片细节。
...
```text
用 $albert-imagebook，把这张照片做成「旅途印记」，不加字。
```

默认生成 1080×1440 的竖版纯作品。要复现本页的上下对照排版，可以说：

```text
用「旅途印记」，原图在上、作品在下，各占一半，成品 1080×1440，不加字。
```

## 原图与作品

![海边日落：原图在上、作品在下](assets/beach-comparison.webp)
...
| 咖啡露台 | 树下街巷 |
| --- | --- |
| [![旅途印记：咖啡露台照片转橡皮章印画](assets/coffee-terrace-65-artwork.webp)](assets/coffee-terrace-65-comparison.webp) | [![旅途印记：林荫街道照片转橡皮章印画](assets/tree-street-65-artwork.webp)](assets/tree-street-65-comparison.webp) |
...
可以直接用中文名「旅途印记」、英文名「Travel Stamps」或风格 ID `rubber-stamp-travel-journal` 调用。
