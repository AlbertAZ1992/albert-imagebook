...
![颜料小岛：厚涂颜料 · 立体刀痕 · 纸上微缩景观](assets/beach-artwork.webp)

## 这一页的特色

可见的厚度、刀痕和投影，让天空、树木和水面都带有堆塑出来的质感。
...
```text
用「颜料小岛」，原图在上、作品在下，各占一半，成品 1080×1440，不加字。
```
...
| 咖啡露台 | 树下街巷 |
| --- | --- |
| [![颜料小岛：咖啡露台照片转厚涂微缩画](assets/coffee-terrace-65-artwork.webp)](assets/coffee-terrace-65-comparison.webp) | [![颜料小岛：林荫街道照片转厚涂微缩画](assets/tree-street-65-artwork.webp)](assets/tree-street-65-comparison.webp) |
...
可以直接用中文名「颜料小岛」、英文名「Impasto Island」或风格 ID `impasto-miniature-world` 调用。
